...
![Trimmomatic](https://img.shields.io/badge/Tool-Trimmomatic-informational)
...
De novo assembly and QC of three wastewater bacterial isolates (ISO1–ISO3), with preserved evidence artifacts (FastQC/QUAST/BUSCO) and a lightweight, reproducible workflow narrative.
...
> **Conclusion from this plot:** All three assemblies are ~99% complete by BUSCO, indicating near-complete recovery of core genes with minimal fragmented/missing hits. ISO3 is still highly complete (C:663) but has the highest duplicated (D:14) and missing (M:7) counts, consistent with greater complexity/heterogeneity and aligning with ISO3’s QUAST outlier signals (size/GC).
